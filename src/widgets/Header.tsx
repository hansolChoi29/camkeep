...
export default function Header() {
  ...
  return (
    <header
      className="
    fixed top-0 text-[#123458] left-0 w-full h-16 bg-[#D4C9BE] z-50
   flex items-center justify-center sm:justify-start /* 로고 중앙 */
    px-4
  "
    >
      <Link href="/">
        <h1 className="logo  text-[32px]  hover:text-[#F1EFEC]  transform transition-transform duration-200 ease-in-out hover:scale-110">
          CAMKEEP
        </h1>
      </Link>
