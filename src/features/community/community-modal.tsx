      ...
      {open && (
        ...
        >
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.2 }}
            className=" p-12 bg-white overflow-y-auto sm:rounded-lg sm:max-w-lg sm:max-h-[80vh] w-full h-full     sm:rounded-lg[scrollbar-width:none]  sm:w-auto sm:h-auto   [&::-webkit-scrollbar]:hidden"
          >
            <div className="w-full relative flex justify-center items-center py-2">
              <h1 className="main w-full flex justify-center items-center">
                나도 게시 할 거야~
              </h1>
              <motion.button
